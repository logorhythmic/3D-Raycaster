...
A simple non DDA based 3D Raycaster built in C using the SDL3 Windowing Library
...
## Info
* Uses the [parametric line intersection formula](https://en.wikipedia.org/wiki/Line%E2%80%93line_intersection) instead of DDA to cast rays
